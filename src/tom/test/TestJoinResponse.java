...
public class TestJoinResponse {
  ...
  public void test() {
    ...
    JoinResponseMessage joinResponse = new JoinResponseMessage(addresses);
    ...
    JoinResponseMessage joinResponse3 = new JoinResponseMessage(addresses);
    ...
    JoinResponseMessage joinResponse4 = (JoinResponseMessage) Message
        .getMessageReceived(joinResponse3.getFullMessage());
    ...
    JoinResponseMessage joinResponse5 = new JoinResponseMessage(addresses);
    ...
    JoinResponseMessage joinResponse6 = (JoinResponseMessage) Message
        .getMessageReceived(joinResponse5.getFullMessage());
